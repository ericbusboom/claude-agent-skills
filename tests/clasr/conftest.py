...
def make_asr_dir(
    ...
    Layout created:
        ...
        asr/claude/settings.json            — parameterized by settings_keys
    ...
    Args:
        ...
        settings_keys: Optional dict of extra keys to include in claude/settings.json.
                       Defaults to {"model": "sonnet", "permissions": ["read"]}.
    """
    src = tmp_path / "asr"
    ...
    base_settings: dict = {"model": "sonnet", "permissions": ["read"]}
    if settings_keys:
        base_settings.update(settings_keys)
