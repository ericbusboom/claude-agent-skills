...
- [ ] Team-lead agent definition instructs providing high-level goals and TODO references to sprint planner
- [ ] Team-lead agent definition explicitly prohibits pre-digesting ticket specs for the sprint planner
- [ ] Sprint-planner agent definition states it owns ticket decomposition, scoping, and specification
- [ ] Sprint-planner agent definition lists the planning decisions it is responsible for
- [ ] Dispatch protocol supports goal-oriented delegation to sprint planner
- [ ] Team-lead delegation instructions are coherent with the raw-text pattern from ticket 006
