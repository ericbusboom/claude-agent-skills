...
- [x] Team-lead agent definition explicitly instructs passing raw stakeholder text to todo-worker
- [x] Team-lead agent definition explicitly prohibits pre-formatting TODO content
- [x] Todo-worker agent definition states it receives raw input and is responsible for all formatting
- [x] Todo-worker agent definition includes responsibility for YAML frontmatter generation
- [x] Dispatch protocol (skill or subagent-protocol) supports raw-text delegation pattern
