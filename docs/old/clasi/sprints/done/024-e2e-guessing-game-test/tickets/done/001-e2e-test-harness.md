...
- [x] `tests/e2e/run_e2e.py` exists and is executable
- [x] Creates a temporary directory that persists after script exit
- [x] Runs `clasi init` successfully in the temp directory
- [x] Copies `guessing-game-spec.md` into the temp project
- [x] Initializes a git repo with an initial commit
- [x] Dispatches a team-lead subagent with the spec and 4-sprint instruction
- [x] Prints the temp directory path for subsequent verification
