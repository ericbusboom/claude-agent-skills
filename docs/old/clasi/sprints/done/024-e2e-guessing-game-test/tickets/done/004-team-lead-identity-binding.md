...
- [x] CLAUDE.md contains explicit team-lead identity statement inside the CLASI block
- [x] The statement says the agent dispatches to subagents and does not write files directly
- [x] AGENTS.md has an `@CLAUDE.md` reference
- [x] Existing `@AGENTS.md` reference in CLAUDE.md still works (no circular loading issues)
